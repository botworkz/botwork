...
pub struct StreamMetricsMessage {
    ...
    pub envoy_metrics:
        ::prost::alloc::vec::Vec<super::super::super::super::io::prometheus::client::MetricFamily>,
}
...
pub mod metrics_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_metrics(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::StreamMetricsMessage>,
        ) -> std::result::Result<tonic::Response<super::StreamMetricsResponse>, tonic::Status>
        {
...
pub mod metrics_service_server {
    ...
    pub const SERVICE_NAME: &str = "envoy.service.metrics.v3.MetricsService";
