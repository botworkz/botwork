...
pub struct Runtime {
    ...
    pub layer: ::core::option::Option<::prost_types::Struct>,
}
...
pub mod runtime_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            RuntimeDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod runtime_discovery_service_server {
    ...
    #[async_trait]
    pub trait RuntimeDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn stream_runtime(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamRuntimeStream>, tonic::Status>;
        ...
        async fn delta_runtime(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaRuntimeStream>, tonic::Status>;
    ...
    /// Discovery service for Runtime resources.
    #[derive(Debug)]
    pub struct RuntimeDiscoveryServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> RuntimeDiscoveryServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RuntimeDiscoveryServiceServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.runtime.v3.RuntimeDiscoveryService/StreamRuntime" => {
                    ...
                    impl<T: RuntimeDiscoveryService>
                        ...
                        > for StreamRuntimeSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RuntimeDiscoveryService>::stream_runtime(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.runtime.v3.RuntimeDiscoveryService/DeltaRuntime" => {
                        ...
                        > for DeltaRuntimeSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuntimeDiscoveryService>::delta_runtime(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/envoy.service.runtime.v3.RuntimeDiscoveryService/FetchRuntime" => {
                        ...
                        > for FetchRuntimeSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RuntimeDiscoveryService>::fetch_runtime(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for RuntimeDiscoveryServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "envoy.service.runtime.v3.RuntimeDiscoveryService";
    impl<T> tonic::server::NamedService for RuntimeDiscoveryServiceServer<T> {
