...
pub mod redis_proxy_external_auth_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            RedisProxyExternalAuthClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod redis_proxy_external_auth_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RedisProxyExternalAuthServer<T>
    where
                ...
                "/envoy.service.redis_auth.v3.RedisProxyExternalAuth/Authenticate" => {
                        ...
                        for AuthenticateSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RedisProxyExternalAuth>::authenticate(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
