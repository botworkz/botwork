        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        where
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::Body>>>::Error:
                Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            VirtualHostDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
...
pub mod route_discovery_service_server {
    ...
    pub trait RouteDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn stream_routes(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamRoutesStream>, tonic::Status>;
        ...
        async fn delta_routes(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaRoutesStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RouteDiscoveryServiceServer<T>
    where
                ...
                "/envoy.service.route.v3.RouteDiscoveryService/StreamRoutes" => {
                        ...
                        > for StreamRoutesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as RouteDiscoveryService>::stream_routes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/envoy.service.route.v3.RouteDiscoveryService/DeltaRoutes" => {
                        ...
                        > for DeltaRoutesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RouteDiscoveryService>::delta_routes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/envoy.service.route.v3.RouteDiscoveryService/FetchRoutes" => {
                        ...
                        > for FetchRoutesSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as RouteDiscoveryService>::fetch_routes(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
...
pub mod virtual_host_discovery_service_server {
    ...
    pub trait VirtualHostDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn delta_virtual_hosts(
            ...
            request: tonic::Request<
                tonic::Streaming<super::super::super::discovery::v3::DeltaDiscoveryRequest>,
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaVirtualHostsStream>, tonic::Status>;
    }
    /// Virtual Host Discovery Service (VHDS) is used to dynamically update the list of virtual hosts for
    /// a given RouteConfiguration. If VHDS is configured a virtual host list update will be triggered
    /// during the processing of an HTTP request if a route for the request cannot be resolved. The
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for VirtualHostDiscoveryServiceServer<T>
    where
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.route.v3.VirtualHostDiscoveryService/DeltaVirtualHosts" => {
                    #[allow(non_camel_case_types)]
                    struct DeltaVirtualHostsSvc<T: VirtualHostDiscoveryService>(pub Arc<T>);
                    impl<T: VirtualHostDiscoveryService>
                        tonic::server::StreamingService<
                            super::super::super::discovery::v3::DeltaDiscoveryRequest,
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        where
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::Body>>>::Error:
                Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            ScopedRoutesDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
...
pub mod scoped_routes_discovery_service_server {
    ...
    #[async_trait]
    pub trait ScopedRoutesDiscoveryService:
        std::marker::Send + std::marker::Sync + 'static
    {
        ...
        async fn stream_scoped_routes(
            ...
            request: tonic::Request<
                tonic::Streaming<super::super::super::discovery::v3::DiscoveryRequest>,
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamScopedRoutesStream>, tonic::Status>;
        ...
        async fn delta_scoped_routes(
            ...
            request: tonic::Request<
                tonic::Streaming<super::super::super::discovery::v3::DeltaDiscoveryRequest>,
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaScopedRoutesStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ScopedRoutesDiscoveryServiceServer<T>
    where
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.route.v3.ScopedRoutesDiscoveryService/StreamScopedRoutes" => {
                    #[allow(non_camel_case_types)]
                    struct StreamScopedRoutesSvc<T: ScopedRoutesDiscoveryService>(pub Arc<T>);
                    impl<T: ScopedRoutesDiscoveryService>
                        tonic::server::StreamingService<
                            super::super::super::discovery::v3::DiscoveryRequest,
                ...
                "/envoy.service.route.v3.ScopedRoutesDiscoveryService/DeltaScopedRoutes" => {
                    #[allow(non_camel_case_types)]
                    struct DeltaScopedRoutesSvc<T: ScopedRoutesDiscoveryService>(pub Arc<T>);
                    impl<T: ScopedRoutesDiscoveryService>
                        tonic::server::StreamingService<
                            super::super::super::discovery::v3::DeltaDiscoveryRequest,
                ...
                "/envoy.service.route.v3.ScopedRoutesDiscoveryService/FetchScopedRoutes" => {
                    #[allow(non_camel_case_types)]
                    struct FetchScopedRoutesSvc<T: ScopedRoutesDiscoveryService>(pub Arc<T>);
                    impl<T: ScopedRoutesDiscoveryService>
                        tonic::server::UnaryService<
                            super::super::super::discovery::v3::DiscoveryRequest,
