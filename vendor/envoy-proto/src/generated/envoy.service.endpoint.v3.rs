...
pub mod endpoint_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            EndpointDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod endpoint_discovery_service_server {
    ...
    pub trait EndpointDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn stream_endpoints(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamEndpointsStream>, tonic::Status>;
        ...
        async fn delta_endpoints(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaEndpointsStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for EndpointDiscoveryServiceServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.endpoint.v3.EndpointDiscoveryService/StreamEndpoints" => {
                    ...
                    impl<T: EndpointDiscoveryService>
                        ...
                        > for StreamEndpointsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as EndpointDiscoveryService>::stream_endpoints(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.endpoint.v3.EndpointDiscoveryService/DeltaEndpoints" => {
                        ...
                        > for DeltaEndpointsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EndpointDiscoveryService>::delta_endpoints(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.endpoint.v3.EndpointDiscoveryService/FetchEndpoints" => {
                        ...
                        > for FetchEndpointsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as EndpointDiscoveryService>::fetch_endpoints(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        where
            ...
            <T as tonic::codegen::Service<http::Request<tonic::body::Body>>>::Error:
                Into<StdError> + std::marker::Send + std::marker::Sync,
        {
            LocalityEndpointDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        /// Compress requests with the given encoding.
        ///
        /// This requires the server to support it otherwise it might respond with an
...
pub mod locality_endpoint_discovery_service_server {
    ...
    #[async_trait]
    pub trait LocalityEndpointDiscoveryService:
        std::marker::Send + std::marker::Sync + 'static
    {
        ...
        async fn delta_locality_endpoints(
            ...
            request: tonic::Request<
                tonic::Streaming<super::super::super::discovery::v3::DeltaDiscoveryRequest>,
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaLocalityEndpointsStream>, tonic::Status>;
    }
    #[derive(Debug)]
    pub struct LocalityEndpointDiscoveryServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> LocalityEndpointDiscoveryServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for LocalityEndpointDiscoveryServiceServer<T>
    where
    ...
    impl<T> Clone for LocalityEndpointDiscoveryServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "envoy.service.endpoint.v3.LocalityEndpointDiscoveryService";
    impl<T> tonic::server::NamedService for LocalityEndpointDiscoveryServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
