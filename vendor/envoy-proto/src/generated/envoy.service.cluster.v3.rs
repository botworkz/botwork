...
pub mod cluster_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            ClusterDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod cluster_discovery_service_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ClusterDiscoveryServiceServer<T>
    where
                ...
                "/envoy.service.cluster.v3.ClusterDiscoveryService/StreamClusters" => {
                        ...
                        > for StreamClustersSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ClusterDiscoveryService>::stream_clusters(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.cluster.v3.ClusterDiscoveryService/DeltaClusters" => {
                        ...
                        > for DeltaClustersSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterDiscoveryService>::delta_clusters(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.cluster.v3.ClusterDiscoveryService/FetchClusters" => {
                        ...
                        > for FetchClustersSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ClusterDiscoveryService>::fetch_clusters(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
