...
pub struct RateLimitQuotaUsageReports {
    ...
    pub bucket_quota_usages:
        ::prost::alloc::vec::Vec<rate_limit_quota_usage_reports::BucketQuotaUsage>,
}
...
pub mod rate_limit_quota_usage_reports {
    ...
    pub struct BucketQuotaUsage {
        ...
        pub time_elapsed: ::core::option::Option<::prost_types::Duration>,
...
pub mod rate_limit_quota_response {
    ...
    pub mod bucket_action {
        ...
        pub struct QuotaAssignmentAction {
            ...
            #[prost(message, optional, tag = "2")]
            pub assignment_time_to_live: ::core::option::Option<::prost_types::Duration>,
...
pub mod rate_limit_quota_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_rate_limit_quotas(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::RateLimitQuotaUsageReports>,
        ) -> std::result::Result<
...
pub mod rate_limit_quota_service_server {
    ...
    pub trait RateLimitQuotaService: std::marker::Send + std::marker::Sync + 'static {
        ...
        ) -> std::result::Result<tonic::Response<Self::StreamRateLimitQuotasStream>, tonic::Status>;
    }
    /// Defines the Rate Limit Quota Service (RLQS).
    #[derive(Debug)]
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for RateLimitQuotaServiceServer<T>
    where
