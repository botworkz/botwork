...
pub mod listener_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            ListenerDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod listener_discovery_service_server {
    ...
    pub trait ListenerDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn delta_listeners(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaListenersStream>, tonic::Status>;
        ...
        async fn stream_listeners(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamListenersStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ListenerDiscoveryServiceServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.listener.v3.ListenerDiscoveryService/DeltaListeners" => {
                    ...
                    impl<T: ListenerDiscoveryService>
                        ...
                        > for DeltaListenersSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ListenerDiscoveryService>::delta_listeners(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.listener.v3.ListenerDiscoveryService/StreamListeners" => {
                        ...
                        > for StreamListenersSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ListenerDiscoveryService>::stream_listeners(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.listener.v3.ListenerDiscoveryService/FetchListeners" => {
                        ...
                        > for FetchListenersSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ListenerDiscoveryService>::fetch_listeners(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
