...
pub mod extension_config_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            ExtensionConfigDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod extension_config_discovery_service_server {
    ...
    #[async_trait]
    pub trait ExtensionConfigDiscoveryService:
        std::marker::Send + std::marker::Sync + 'static
    {
        ...
        async fn stream_extension_configs(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamExtensionConfigsStream>, tonic::Status>;
        ...
        async fn delta_extension_configs(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::DeltaExtensionConfigsStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ExtensionConfigDiscoveryServiceServer<T>
    where
