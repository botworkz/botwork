...
pub struct ClientStatusRequest {
    ...
    pub node_matchers:
        ::prost::alloc::vec::Vec<super::super::super::r#type::matcher::v3::NodeMatcher>,
...
pub mod client_config {
    ...
    pub struct GenericXdsConfig {
        ...
        pub xds_config: ::core::option::Option<::prost_types::Any>,
        ...
        pub error_state:
            ::core::option::Option<super::super::super::super::admin::v3::UpdateFailureState>,
...
pub mod client_status_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            ClientStatusDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn stream_client_status(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::ClientStatusRequest>,
        ) -> std::result::Result<
        ...
        ) -> std::result::Result<tonic::Response<super::ClientStatusResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
...
pub mod client_status_discovery_service_server {
    ...
    #[async_trait]
    pub trait ClientStatusDiscoveryService:
        std::marker::Send + std::marker::Sync + 'static
    {
        ...
        ) -> std::result::Result<tonic::Response<Self::StreamClientStatusStream>, tonic::Status>;
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for ClientStatusDiscoveryServiceServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.status.v3.ClientStatusDiscoveryService/StreamClientStatus" => {
                    ...
                    struct StreamClientStatusSvc<T: ClientStatusDiscoveryService>(pub Arc<T>);
                    impl<T: ClientStatusDiscoveryService>
                ...
                "/envoy.service.status.v3.ClientStatusDiscoveryService/FetchClientStatus" => {
                    #[allow(non_camel_case_types)]
                    struct FetchClientStatusSvc<T: ClientStatusDiscoveryService>(pub Arc<T>);
                    impl<T: ClientStatusDiscoveryService>
