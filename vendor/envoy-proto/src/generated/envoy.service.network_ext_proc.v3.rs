...
pub mod network_external_processor_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            NetworkExternalProcessorClient::new(InterceptedService::new(inner, interceptor))
        }
...
pub mod network_external_processor_server {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for NetworkExternalProcessorServer<T>
    where
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.network_ext_proc.v3.NetworkExternalProcessor/Process" => {
                    ...
                    impl<T: NetworkExternalProcessor>
                        ...
                        for ProcessSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as NetworkExternalProcessor>::process(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
