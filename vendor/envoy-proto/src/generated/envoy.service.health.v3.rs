...
pub struct EndpointHealth {
    ...
    pub health_metadata: ::core::option::Option<::prost_types::Struct>,
}
...
pub struct HealthCheckRequestOrEndpointHealthResponse {
    ...
    pub request_type:
        ::core::option::Option<health_check_request_or_endpoint_health_response::RequestType>,
}
...
pub struct ClusterHealthCheck {
    ...
    pub upstream_bind_config:
        ::core::option::Option<super::super::super::config::core::v3::BindConfig>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod health_discovery_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        {
            HealthDiscoveryServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn fetch_health_check(
            &mut self,
            request: impl tonic::IntoRequest<super::HealthCheckRequestOrEndpointHealthResponse>,
        ) -> std::result::Result<tonic::Response<super::HealthCheckSpecifier>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
...
pub mod health_discovery_service_server {
    ...
    pub trait HealthDiscoveryService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn stream_health_check(
            ...
            >,
        ) -> std::result::Result<tonic::Response<Self::StreamHealthCheckStream>, tonic::Status>;
        /// TODO(htuch): Unlike the gRPC version, there is no stream-based binding of
        /// request/response. Should we add an identifier to the HealthCheckSpecifier
        /// to bind with the response?
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for HealthDiscoveryServiceServer<T>
    where
                ...
                "/envoy.service.health.v3.HealthDiscoveryService/StreamHealthCheck" => {
                        ...
                        > for StreamHealthCheckSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as HealthDiscoveryService>::stream_health_check(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/envoy.service.health.v3.HealthDiscoveryService/FetchHealthCheck" => {
                        ...
                        > for FetchHealthCheckSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as HealthDiscoveryService>::fetch_health_check(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
