...
pub mod access_log_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_access_logs(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::StreamAccessLogsMessage>,
        ) -> std::result::Result<tonic::Response<super::StreamAccessLogsResponse>, tonic::Status>
        {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/envoy.service.accesslog.v3.AccessLogService/StreamAccessLogs" => {
                    ...
                    impl<T: AccessLogService>
                        tonic::server::ClientStreamingService<super::StreamAccessLogsMessage>
                        for StreamAccessLogsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AccessLogService>::stream_access_logs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
