...
pub mod event_reporting_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn stream_events(
            &mut self,
            request: impl tonic::IntoStreamingRequest<Message = super::StreamEventsRequest>,
        ) -> std::result::Result<
...
pub mod event_reporting_service_server {
    ...
    #[async_trait]
    pub trait EventReportingService: std::marker::Send + std::marker::Sync + 'static {
    ...
    /// such events may be health check or outlier detection events.
    #[derive(Debug)]
    pub struct EventReportingServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> EventReportingServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for EventReportingServiceServer<T>
    where
                ...
                "/envoy.service.event_reporting.v3.EventReportingService/StreamEvents" => {
                        ...
                        for StreamEventsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as EventReportingService>::stream_events(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    impl<T> Clone for EventReportingServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "envoy.service.event_reporting.v3.EventReportingService";
    impl<T> tonic::server::NamedService for EventReportingServiceServer<T> {
