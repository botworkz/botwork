...
pub struct LoadStatsRequest {
    ...
    pub cluster_stats:
        ::prost::alloc::vec::Vec<super::super::super::config::endpoint::v3::ClusterStats>,
}
...
pub struct LoadStatsResponse {
    ...
    pub load_reporting_interval: ::core::option::Option<::prost_types::Duration>,
...
pub mod load_reporting_service_server {
    ...
    pub trait LoadReportingService: std::marker::Send + std::marker::Sync + 'static {
        ...
        ) -> std::result::Result<tonic::Response<Self::StreamLoadStatsStream>, tonic::Status>;
    }
    #[derive(Debug)]
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for LoadReportingServiceServer<T>
    where
                ...
                "/envoy.service.load_stats.v3.LoadReportingService/StreamLoadStats" => {
                        ...
                        for StreamLoadStatsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as LoadReportingService>::stream_load_stats(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
