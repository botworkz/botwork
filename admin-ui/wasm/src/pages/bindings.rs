...
//!
//! Both update and delete go through admin-api's live-state gate:
//! before mutating, admin-api asks control-plane to terminate any
            ...
            <AsyncView
                ...
                children=Box::new(move |b: api::WorkspacePlugin| {
                    ...
                    view! {
                        ...
                        <p class="muted">
                            "admin-api walks the live-state gate against control-plane \
