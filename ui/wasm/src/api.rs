...
pub async fn create_workspace(tenant: &str, body: &WorkspaceCreate) -> Result<Workspace, ApiError> {
    send_json("POST", &format!("{API_BASE}/tenant/{tenant}/workspaces"), Some(body)).await
}

pub async fn update_workspace(tenant: &str, id: &str, body: &WorkspaceUpdate) -> Result<Workspace, ApiError> {
    send_json("PUT", &format!("{API_BASE}/tenant/{tenant}/workspaces/{id}"), Some(body)).await
}
...
pub async fn create_workspace_plugin(
    ...
    send_json("POST", &format!("{API_BASE}/tenant/{tenant}/workspace_plugins"), Some(body)).await
}
...
pub async fn delete_workspace_plugin(tenant: &str, workspace_id: &str, plugin_id: &str) -> Result<(), ApiError> {
