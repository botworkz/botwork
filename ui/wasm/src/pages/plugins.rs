...
//! means the operator sees the canonical form api returns,
//! and edits are sent verbatim; api's validator owns the
...
/// in practice — every input here came from api's serializer).
...
impl PluginForm {
    ...
    /// None-fields are omitted from the wire payload; api fills
                    ...
                    view! {
                        ...
                        <p class="muted">
                            "The plugin row is FK-RESTRICTed by any workspace_plugin \
                             ...
                             api returns 409 has_dependents and names them \
